...
from latent_dialog.data_loaders import BaseDataLoader, MultiWozDataLoader
from latent_dialog.data_loaders.woz_corpora import USR, SYS

logger = logging.getLogger()


class CamRestDataLoader(BaseDataLoader):

    def __init__(self, mode, data, config):
        super(CamRestDataLoader, self).__init__(mode)
        self.mode = mode  
        self.raw_data = data
        self.config = config
